...
<br>
The XLS report file shown in the example above was generated by the instructions in this 'Rent, Please!' readme and can be downloaded below to be examined. 
<br>
Change the file format to CSV after downloading the example report:
<br>
